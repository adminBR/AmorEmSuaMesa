...
public class Carrinho extends AppCompatActivity {
    ...
    public void loadCart(){
        ...
        for (int i = 0; i < staticStorageClass.carrinho.size(); i++) {
            ...
            nome.setText(staticStorageClass.carrinho.get(i).getName());
            TextView preco = view.findViewById(R.id.cilPreco);
            preco.setText("R$ "+staticStorageClass.carrinho.get(i).getPrice()+",00");
            TextView uni = view.findViewById(R.id.cilUnidades);
            uni.setText("1 Un.");
            total+=Integer.parseInt(staticStorageClass.carrinho.get(i).getPrice());
